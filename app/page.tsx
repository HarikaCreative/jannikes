...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-cream">
      ...
      <a 
        href="#main-content" 
        className="sr-only focus:not-sr-only focus:absolute focus:top-4 focus:left-4 focus:z-[100] focus:px-4 focus:py-2 focus:bg-cerise focus:text-white focus:rounded-lg focus:outline-none"
      >
      ...
      <header role="banner">
        <nav 
          className="fixed top-0 left-0 right-0 z-50 bg-gradient-to-r from-turkis to-mint shadow-sm"
          role="navigation"
        ...
        >
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex justify-between items-center h-20">
              ...
              <a 
                ...
                aria-label="Jannikes Catering - Gå til toppen"
              >
                <img 
                  src="/images/android-chrome-512x512.png" 
                  alt="Jannikes Catering logo" 
              ...
              <div className="hidden md:flex items-center space-x-8">
                <a 
                  href="#catering" 
                  className="text-white hover:text-cream transition-colors font-semibold"
                >
                  Catering
                </a>
                <a 
                ...
                <button
                  ...
                  className="px-6 py-3 bg-gradient-to-r from-cerise to-orange text-white font-semibold rounded-full hover:shadow-lg transition-all"
                  aria-label="Åpne kontaktskjema for å be om tilbud"
                >
                  Be om tilbud
                </button>
              </div>
          ...
          >
            <nav className="flex flex-col h-full pt-20 px-6 space-y-6" aria-label="Mobilnavigasjon">
              <a 
                href="#catering" 
              ...
              <button
                ...
                className="px-6 py-3 bg-gradient-to-r from-cerise to-orange text-white font-semibold rounded-full hover:shadow-lg transition-all text-center"
              >
                Be om tilbud
              </button>
            </nav>
      ...
      {/* Footer with Schema.org microdata */}
      <footer 
        className="bg-brun text-cream py-12"
        role="contentinfo"
        itemScope 
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div className="md:col-span-2">
              ...
              <p 
                className="text-sm text-cream/80 font-display italic"
                itemProp="slogan"
              >
                Fargerik mat. Varme mennesker. Kreative opplevelser.
              </p>
              <meta itemProp="name" content="Jannikes Catering" />
              <meta itemProp="description" content="Profesjonell catering og vertinnetjenester i Oslo, Asker og Bærum" />
            </div>
            
            {/* Kontakt */}
            <div>
              <h2 className="font-semibold mb-4 font-display text-lg">Kontakt</h2>
              <address 
                className="not-italic space-y-3 text-sm text-cream/80"
                itemProp="address" 
                itemScope 
            ...
            {/* Sosiale medier */}
            <div>
              <h2 className="font-semibold mb-4 font-display text-lg">Følg oss</h2>
          ...
          <div className="mt-8 pt-8 border-t border-cream/20">
            <div className="flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-cream/60">
              <nav className="flex gap-4" aria-label="Juridiske lenker">
              ...
              <p>
                ...
                {' '}Jannikes Catering {new Date().getFullYear()}. 
                Utviklet av{' '}
                <a 
                  href="https://harikacreative.com" 
                  target="_blank" 
                  rel="noopener noreferrer"
                  className="hover:text-orange transition-colors"
                >
